                        ...
                        <div class="card-body">
                            <form id="reg-form" action="RegisterServlet" method="POST">
                                ...
                                <div class="form-group">
                                    ...
                                    <input name="user_name" type="text" class="form-control" id="user_name" style="text-transform: uppercase" aria-describedby="emailHelp" placeholder="Enter name">
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <input name="user_age" type="text" class="form-control" id="user_age" placeholder="Enter Age">
                                </div>
