...
//            fetch username and password from request
            ...
            Double am = (acc.getAmount() + Double.valueOf(amount));
            acc.setAmount(am);
            System.out.println(am+ ": "+ acc.getAmount());
            ...
            if (u != 0) {
            	...
            	Transactions t = new Transactions(acc.getCustID(),acc.getId(),"Deposit",am);
            	t.setDate(dtf.format(now));
                int bol = dao1.saveTransaction(t);
                Message m = new Message("Deposit Successfully", "success", "alert-success");
